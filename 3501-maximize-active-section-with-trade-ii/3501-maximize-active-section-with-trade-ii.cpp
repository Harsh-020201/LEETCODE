...
class Solution {
 public:
  vector<int> maxActiveSectionsAfterTrade(string s,
    ...
    for (const vector<int>& query : queries) {
      ...
      // Case: partial right group + previous full group
 ...
 private:
  // Returns the zero groups and the group index for each position.
  ...
  // Returns the sums of adjacent zero-group lengths.
  ...
  // Maps group indices to adjacent-group indices.
